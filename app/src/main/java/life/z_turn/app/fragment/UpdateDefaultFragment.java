...
public class UpdateDefaultFragment extends Fragment implements InfoAdapter.OnItemClickListener {
    ...
    private InfoAdapter.InfoViewHolder mHolder;
    ...
    private void setData() {
        ...
        mData.add(new InfoBean("地点",null));
    ...
    private void saveData() {
        ...
        object.put(Constants.COLUMN_START_DATE, startDate);
        object.put(Constants.COLUMN_END_DATE, endDate);
        object.put(Constants.COLUMN_TYPE, Constants.TYPE_DEFAULT);
        object.saveInBackground(new SaveCallback() {
            @Override
            public void done(AVException e) {
                if (e == null) {

                    LogUtil.i("yyyyyyyyyyyyyyy","yyyyyyyyyyyy");
    ...
    public void onItemClick(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        switch (position) {
            ...
            case 1:
                mHolder = holder;
                EditIntroduceActivity_.intent(this).startForResult(Constants.REQUEST_EDIT_INTRODUCE);
                break;
            case 2:
                isStart = true;
            ...
            case 5:
                ...
                break;
            case 6:
                showAddressDialog(holder, position);
                break;
            case 7:
                showJoinNumDialog(holder, position);
                break;
            case 8:
                showCurrentJoinNumDialog(holder,position);
                break;
    ...
    private void showAddressDialog(InfoAdapter.InfoViewHolder holder, int position) {
    ...
    private void showCurrentJoinNumDialog(InfoAdapter.InfoViewHolder holder, int position) {
        AlertDialog d = new AlertDialog.Builder(getActivity())
                .setTitle("标题")
                .setNegativeButton("取消", null)
                .setPositiveButton("确定", null)
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == Constants.REQUEST_EDIT_INTRODUCE && resultCode == Activity.RESULT_OK) {
            if (data != null) {
                mIntroduce = data.getStringExtra(Constants.EXTRA_KEY_INTRODUCE_CONTENT);
                mHolder.value.setText(mIntroduce);
            }
        }
    }
}
