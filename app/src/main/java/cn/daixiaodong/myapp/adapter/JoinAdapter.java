...
public class JoinAdapter extends RecyclerView.Adapter<JoinAdapter.MyViewHolder> {
    ...
    public JoinAdapter(Context context, List<AVObject> data) {
        this.mContext = context;
        this.mDataSet = data;
        this.mLayoutInflater = LayoutInflater.from(context);
    ...
    @Override
    public JoinAdapter.MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(final JoinAdapter.MyViewHolder viewHolder, final int i) {
        ...
        AVObject dream = mDataSet.get(i).getAVObject("dream");
