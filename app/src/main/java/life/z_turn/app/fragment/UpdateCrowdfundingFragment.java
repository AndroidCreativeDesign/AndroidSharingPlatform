...
public class UpdateCrowdfundingFragment extends Fragment implements InfoAdapter.OnItemClickListener {
    ...
    private void saveData() {
        ...
        object.put(Constants.COLUMN_TYPE, Constants.TYPE_CROWDFUNDING);
