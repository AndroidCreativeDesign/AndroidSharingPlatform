 ...
 * 用户关注的其他用户列表  Adapter
 */
public class AssociationMemberAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AssociationMemberAdapter(Context context, List<AVObject> data) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder viewHolder, final int i) {
        ...
        switch (getItemViewType(i)) {
            case TYPE_FOOTER_VIEW:
                return;
            case TYPE_DEFAULT:
                AVUser user =  mDataSet.get(i).getAVUser(Constants.COLUMN_USER);
