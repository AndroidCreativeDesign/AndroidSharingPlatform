...
public class CollectAdapter extends RecyclerView.Adapter<CollectAdapter.MyViewHolder> {
    ...
    public CollectAdapter(Context context, List<AVObject> data) {
        this.mContext = context;
        this.mDataSet = data;
        this.mLayoutInflater = LayoutInflater.from(context);
    ...
    @Override
    public CollectAdapter.MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(final CollectAdapter.MyViewHolder viewHolder, final int i) {
        ...
        viewHolder.title.setText(mDataSet.get(i).getAVObject("event").getString("title"));
