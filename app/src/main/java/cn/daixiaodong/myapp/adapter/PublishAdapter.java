...
public class PublishAdapter extends RecyclerView.Adapter<PublishAdapter.MyViewHolder> {
    ...
    public PublishAdapter(Context context, List<AVObject> data) {
        this.mContext = context;
        this.mDataSet = data;
        this.mLayoutInflater = LayoutInflater.from(context);
    ...
    @Override
    public PublishAdapter.MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(final PublishAdapter.MyViewHolder viewHolder, final int i) {
